...
pub struct ComposeObjectRequest {
    ...
    pub source_objects:
        ::prost::alloc::vec::Vec<compose_object_request::SourceObjects>,
    ...
    pub common_object_request_params:
        ::core::option::Option<CommonObjectRequestParams>,
    /// A set of parameters common to all Storage API requests.
    #[prost(message, optional, tag = "10")]
    pub common_request_params: ::core::option::Option<CommonRequestParams>,
}
...
pub mod compose_object_request {
    ...
    pub struct SourceObjects {
        ...
        pub object_preconditions:
            ::core::option::Option<source_objects::ObjectPreconditions>,
    }
...
pub struct GetIamPolicyRequest {
    ...
    #[prost(message, optional, tag = "1")]
    pub iam_request:
        ::core::option::Option<::google_iam_iam_policy::GetIamPolicyRequest>,
    /// A set of parameters common to all Storage API requests.
    #[prost(message, optional, tag = "2")]
    pub common_request_params: ::core::option::Option<CommonRequestParams>,
}
...
pub struct SetIamPolicyRequest {
    ...
    #[prost(message, optional, tag = "1")]
    pub iam_request:
        ::core::option::Option<::google_iam_iam_policy::SetIamPolicyRequest>,
    /// A set of parameters common to all Storage API requests.
    #[prost(message, optional, tag = "2")]
    pub common_request_params: ::core::option::Option<CommonRequestParams>,
}
...
pub struct TestIamPermissionsRequest {
    ...
    #[prost(message, optional, tag = "1")]
    pub iam_request:
        ::core::option::Option<::google_iam_iam_policy::TestIamPermissionsRequest>,
    /// A set of parameters common to all Storage API requests.
    #[prost(message, optional, tag = "2")]
    pub common_request_params: ::core::option::Option<CommonRequestParams>,
}
